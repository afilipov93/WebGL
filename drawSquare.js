...
function addTriangle(x1, y1, x2, y2, orientation) {

  var triangle = new THREE.Geometry();
  if(orientation == "l") {
  triangle.vertices.push( new THREE.Vector3(x1, y1, 0));
  triangle.vertices.push( new THREE.Vector3(x2, y1, 0));
  triangle.vertices.push( new THREE.Vector3(x2, y2, 0));
  }
  else if(orientation == "u") {
  triangle.vertices.push( new THREE.Vector3(x1, y1, 0));
  triangle.vertices.push( new THREE.Vector3(x1, y2, 0));
  triangle.vertices.push( new THREE.Vector3(x2, y2, 0));
  }
...
function drawSquare(x1, y1, x2, y2) {
  ...
  face1 = drawTriangle(x1, y1, x2, y2, 'u');
  face2 = drawTriangle(x1, y1, x2, y2, 'l');
